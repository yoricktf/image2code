					...
					<header className="text-center">
						...
						<div className="overflow-y-auto py-4 px-3 mt-4 bg-gray-50 rounded dark:bg-gray-800 h-auto">
							<p className="mt-2 text-sm text-gray-600 dark:text-gray-400 text-justify ">
								...
								transforming them into functional code. Powered by Chat GPT-4 and advanced image analysis technologies,
								our platform interprets your images and converts them into HTML, JavaScript, and CSS, Tailwind,
								Bootstrap or Mterial code structures, depending on your preferences.
							...
							<p className="mt-2 text-sm text-gray-600 dark:text-gray-400 text-justify">
								If you dont pick any framework of your preference, by default the application is using just CSS. <br />{' '}
